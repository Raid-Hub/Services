...
**Canonical spec (in each repo):** [`docs/DISCORD_LINKED_ROLES.md`](./DISCORD_LINKED_ROLES.md) (Part VII = implementable checklist). Keep this file and the spec in sync when you edit either; merge **Website PR before** enabling workers in prod (see §Dependency rule).
