...
-- Outbound channel (e.g. Discord webhook). Primary key is the stable destination id.
CREATE TABLE "subscriptions"."destination" (
    ...
    CONSTRAINT "destination_channel_type_chk" CHECK ("channel_type" IN ('discord_webhook'))
);
